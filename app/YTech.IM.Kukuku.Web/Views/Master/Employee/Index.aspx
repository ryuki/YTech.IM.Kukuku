                ...
                colModel: [
                   ...
                   { name: 'PersonGender', index: 'PersonGender', width: 200, sortable: false, align: 'left', editable: true, edittype: 'select', editoptions: { value: "Pria:Pria;Wanita:Wanita" }, editrules: { required: false} },
                    ...
                    { name: 'DepartmentName', index: 'DepartmentName', width: 200, align: 'left', editable: false, edittype: 'select', editrules: { edithidden: true} },
                     { name: 'EmployeeCommissionProductType', index: 'EmployeeCommissionProductType', width: 200, align: 'left', editable: true, edittype: 'select', editrules: { edithidden: true}, hidden: false },
                    { name: 'EmployeeCommissionProductVal', index: 'EmployeeCommissionProductVal', width: 200, align: 'right', editable: true, hidden: false, editrules: { edithidden: true },
                        editoptions: {
