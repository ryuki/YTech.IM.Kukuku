        ...
        $(document).ready(function () {
            ...
            $("#list").jqGrid({
                ...
                colModel: [
                   ...
                   { name: 'PersonReligion', index: 'PersonReligion', width: 200, hidden: true, align: 'left', editable: false, edittype: 'select', editrules: { required: false, edithidden: true} },
                   { name: 'PersonRace', index: 'PersonRace', width: 200, hidden: true, align: 'left', editable: false, edittype: 'text', editrules: { required: false, edithidden: true} },
                   { name: 'CustomerHealthProblem', index: 'CustomerHealthProblem', width: 200, hidden: true, align: 'left', editable: false, edittype: 'textarea', editoptions: { rows: "3", cols: "20" }, editrules: { required: false, edithidden: true} },
                   ...
                   { name: 'CustomerProductDisc', index: 'CustomerProductDisc', width: 200, hidden: true, align: 'left', editable: false, edittype: 'text', editrules: { required: false, edithidden: true },
                       editoptions: {
                 ...
                 { name: 'CustomerStatus', index: 'CustomerStatus', width: 200, hidden: true, sortable: false, align: 'left', editable: true, edittype: 'checkbox', editoptions: { value: "Aktif:Tidak Aktif" }, editrules: { required: false} },
                   { name: 'CustomerMassageStrength', index: 'CustomerMassageStrength', width: 200, hidden: true, align: 'left', editable: false, edittype: 'select', editrules: { required: false, edithidden: true} },
