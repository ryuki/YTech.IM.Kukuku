...
namespace YTech.IM.Kukuku.Web.Controllers.Helper
{
    public class CommonHelper
    {
        private const string CONST_FACTURFORMAT = "KUKUKU/[TRANS]/[YEAR]/[MONTH]/[DAY]/[XXX]";
        public const string CONST_VOUCHERNO = "KUKUKU/VOUCHER/[YEAR]/[MONTH]/[DAY]/[XXX]";
        ...
        public static string GetFacturNo(EnumTransactionStatus transactionStatus, bool automatedIncrease)
        {
            ...
            if (transactionStatus == EnumTransactionStatus.Service)
            {
                tipeTrans = "SVC";
            }
